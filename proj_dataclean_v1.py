...
corresponds to the general requirements for standard single-crystal X-ray 
diffraction data collection.) Product purity was coded with the labels 1 for a
multiphase product or 2 for a single-phase product.
"""